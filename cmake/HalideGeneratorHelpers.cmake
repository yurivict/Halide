...
function(_Halide_target_link_gpu_libs TARGET VISIBILITY)
    if ("${ARGN}" MATCHES "opengl")
        ...
        target_link_libraries(${TARGET} ${VISIBILITY} HalideGeneratorHelpers::X11)
    ...
    if ("${ARGN}" MATCHES "cuda")
        if (NOT TARGET HalideGeneratorHelpers::CUDA)
            ...
            if (NOT CUDA_FOUND)
                ...
                target_link_libraries(HalideGeneratorHelpers_CUDA INTERFACE ${CUDA_LIBRARIES})
            endif ()
        endif ()
        target_link_libraries(${TARGET} ${VISIBILITY} HalideGeneratorHelpers::CUDA)
    endif ()

    if ("${ARGN}" MATCHES "opencl")
        if (NOT TARGET OpenCL::OpenCL)
            find_package(OpenCL QUIET)
            if (NOT OpenCL_FOUND)
                message(AUTHOR_WARNING "OpenCL dependency not found on system.")
            endif ()
        endif ()
        target_link_libraries(${TARGET} ${VISIBILITY} OpenCL::OpenCL)
    endif ()
